...
<head>
    ...
    <title>Tasker Company API</title>
...
*/.hljs{color:#24292e;background:#fff}.hljs-doctag,.hljs-keyword,.hljs-meta .hljs-keyword,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable.language_{color:#d73a49}.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#6f42c1}.hljs-attr,.hljs-attribute,.hljs-literal,.hljs-meta,.hljs-number,.hljs-operator,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id,.hljs-variable{color:#005cc5}.hljs-meta .hljs-string,.hljs-regexp,.hljs-string{color:#032f62}.hljs-built_in,.hljs-symbol{color:#e36209}.hljs-code,.hljs-comment,.hljs-formula{color:#6a737d}.hljs-name,.hljs-quote,.hljs-selector-pseudo,.hljs-selector-tag{color:#22863a}.hljs-subst{color:#24292e}.hljs-section{color:#005cc5;font-weight:700}.hljs-bullet{color:#735c0f}.hljs-emphasis{color:#24292e;font-style:italic}.hljs-strong{color:#24292e;font-weight:700}.hljs-addition{color:#22863a;background-color:#f0fff4}.hljs-deletion{color:#b31d28;background-color:#ffeef0}
    ...
    <style>
                    #frame-0 .hljs-ln-line[data-line-number='33'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                    #frame-1 .hljs-ln-line[data-line-number='21'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                ...
                background-color: rgba(242, 95, 95, 0.4);
                    ...
                    #frame-6 .hljs-ln-line[data-line-number='144'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                    #frame-7 .hljs-ln-line[data-line-number='51'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                    #frame-8 .hljs-ln-line[data-line-number='183'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                    #frame-9 .hljs-ln-line[data-line-number='119'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                ...
                background-color: rgba(242, 95, 95, 0.4);
                    ...
                    #frame-27 .hljs-ln-line[data-line-number='183'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                ...
                background-color: rgba(242, 95, 95, 0.4);
                    ...
                    #frame-32 .hljs-ln-line[data-line-number='119'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
                ...
                background-color: rgba(242, 95, 95, 0.4);
                    ...
                    #frame-35 .hljs-ln-line[data-line-number='1190'] {
                background-color: rgba(242, 95, 95, 0.4);
            }
        ...
        <div class="hidden text-right shrink-0 md:block md:min-w-64 md:max-w-80">
            <div>
                <span class="inline-block rounded-full bg-gray-200 px-3 py-2 text-sm leading-5 text-gray-900 max-w-full truncate dark:bg-gray-800 dark:text-white">
                    POST api.taskercompany.com
                </span>
            </div>
            <div class="px-4">
                <span class="text-sm text-gray-500 dark:text-gray-400">PHP 8.3.16 — Laravel 11.37.0</span>
            </div>
        </div>
    </div>
</section>
...
>
  ...
  <path fill-rule="evenodd" d="M9.47 6.47a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 1 1-1.06 1.06L10 8.06l-3.72 3.72a.75.75 0 0 1-1.06-1.06l4.25-4.25Z" clip-rule="evenodd" />
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">App\Http\Controllers\HealthCheckController</span>
        ...
        <div class="mb-3">
            <div class="text-md text-gray-500 dark:text-gray-400">
                <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">app/Http/Controllers/HealthCheckController.php</span>
    ...
    private function decryptMessage($encryptedMessage, $privateKey)
    {
        // Decrypt the encrypted message using openssl
        if (openssl_private_decrypt(base64_decode($encryptedMessage), $decryptedMessage, $privateKey)) {
    ...
    >
        ...
        // Decrypt the message
        $decryptedMessage = $this-&gt;decryptMessage($encryptedMessage, $privateKey);

        // Returning HTTP 200 response with decrypted message
        return response()-&gt;json([
            &#039;status&#039; =&gt; &#039;success&#039;,
            &#039;decrypted_message&#039; =&gt; $decryptedMessage
        ], 200); // Explicitly returning status 200
    }
...
>
    ...
    <div class="mt-2">
        <span>POST</span>
        <span class="text-gray-500">/api/health-check</span>
    </div>
    ...
    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                ...
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">deflate, gzip</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                ...
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">514</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                ...
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">api.taskercompany.com</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                ...
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                    data-tippy-content="x-hub-signature"
                    class="lg:text-md w-[8rem] flex-none cursor-pointer truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]"
                >
                    x-hub-signature
                </span>
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">sha256=156542e27f1b70ce559c1a411898a9d50e835ab2d22a7a86b78750a6ca31b9f9</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
                    data-tippy-content="x-hub-signature-256"
                    class="lg:text-md w-[8rem] flex-none cursor-pointer truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]"
                >
                    x-hub-signature-256
                </span>
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">sha256=22ed79d8cf57cf0cb41d5651422bd36b404799759d2173ee0b917390518c3cce</code></pre>
                </span>
            </div>
            </dl>
    ...
    &quot;encrypted_flow_data&quot;: &quot;oVfTWaXfPrB0ILFAjij6lNJoFRttnFYE/pbC7Zl4RTbBiLVoSUSalCYJYVWb2ihfjQ==&quot;,
    &quot;encrypted_aes_key&quot;: &quot;&quot;,
    &quot;initial_vector&quot;: &quot;qtROJ42vQ52xksCjj6iDMw==&quot;
}</code></pre>
            </span>
        </div>
    </div>
...
>
    ...
    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                ...
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">App\Http\Controllers\HealthCheckController@healthCheck</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
